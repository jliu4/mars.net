...
Friend Class PltOctagon3d
	...
	Public theLength As Double
	Public theHeight As Double
	Public X As Double
	Public Y As Double
	Public z As Double
	...
	Public Sub createOctagon(ByRef Length As Double, ByRef Height As Double, ByRef xCenter As Double, ByRef ycenter As Double, ByRef zBase As Double)
		Dim x1 As Double
		Dim y1 As Double
