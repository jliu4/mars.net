...
Friend Class threeDObject
	...
	'Public Function Add(x1 As Double, y1 As Double, z1 As Double, _
	''                    x2 As Double, y2 As Double, z2 As Double) As threeDLine
	...
	Public Function AddLines(ByRef Num3DLines As Short, ByRef Lines() As Double) As Object
		Dim LN As Short
	...
	Public Function Translate(ByRef dx As Double, ByRef dy As Double, ByRef Dz As Double) As Object
	...
	Public Function Rotate(ByRef ThetaX As Double, ByRef ThetaY As Double, ByRef ThetaZ As Double) As Object
		Dim Line3D As threeDLine
		'UPGRADE_WARNING: Lower bound of array X was changed from 1 to 0. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="0F1C9BE1-AF9D-476E-83B1-17D43BECFF20"'
		Dim X(6) As Double
