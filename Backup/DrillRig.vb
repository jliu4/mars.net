...
Friend Class PltDrillRig
	...
	Private Const GroundHeight As Double = DeckElev + 8
	
	Private Const BaseWidth As Double = 3.28 * 24
	Private Const BaseHeight As Double = 3.28 * 4
	Private Const BaseLength As Double = 3.28 * 15
	
	Private Const aboveBaseHeight As Double = 3.28 * 26
	Private Const aboveBaseLength As Double = 3.28 * 15
	Private Const aboveBaseWidth As Double = 3.28 * 16
	
	Private Const namePlateLength As Double = 15 * 3.28
	Private Const namePlateWidth As Double = 20 * 3.28
	Private Const namePlateHeight As Double = 7 * 3.28
	
	Private Const topPyrHeight As Double = 3.28 * 17.5
	Private Const topPyrBLength As Double = 3.28 * 15
	Private Const topPyrBWidth As Double = 3.28 * 16
	Private Const topPyrTLength As Double = 3.28 * 7
	Private Const topPyrTWidth As Double = 3.28 * 6
	
	Private Const theTopLength As Double = 3.28 * 7
	Private Const theTopWidth As Double = 3.28 * 6
	Private Const theTopHeight As Double = 3.28 * 13.5
