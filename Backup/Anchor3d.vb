...
Friend Class PltAnchor
	...
	Private Const anchorLength As Double = 40
	
	' width is as seen from a overhead view, the back
	' part
	Private Const anchorWidth As Double = 30
	
	' estimated as a ratio of Height to Length
	Private Const anchorHeight As Double = 3 / 6 * 40
	
	' estimated length of the base of the anchor
	Private Const BaseLength As Double = 3.28 * 10 '6.294
	
	' estimation of the angle between the fins and the base
	Private Const BaseFinAngle As Double = 31
	...
	Private zCenter As Double
	
	Public Sub createAnchor(ByRef X As Double, ByRef Y As Double, ByRef z As Double) ', angle As Double)
