...
Friend Class PltBraces
	...
	Public Sub createBrace(ByVal startx As Double, ByVal startY As Double, ByRef startZ As Double, ByRef finishX As Double, ByRef finishY As Double, ByRef finishZ As Double)
		Dim X0 As Double
		Dim Y0 As Double
		Dim z0 As Double
		Dim temp1 As Double
