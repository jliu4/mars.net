...
Friend Class PltVessel
	...
	Public Sub setGraph(ByRef gIn As System.Windows.Forms.PictureBox, ByRef X As Double, ByRef Y As Double, ByRef Incremental As Boolean)
	...
	Public Function ZoomGraph(ByVal aChange As Double) As Object
