...
Friend Class PltColumns
	...
	Private Const BackCol1Length As Double = PontWidth '...back box column width
	Private Const BackCol1Width As Double = 17 '...back box column length
	Private Const BackCol2Length As Double = PontWidth '... rear octagon column
	Private Const SmallLength As Double = 3.28 * 5.8
	'...modify by neil
	Private Const BackCol3Length As Double = 17 '...back box column width (new pontoon)
	Private Const BackCol3Width As Double = PontWidth '...back box column length (new pontoon)
