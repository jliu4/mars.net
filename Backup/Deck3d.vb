...
Friend Class PltDeck3d
	...
	Private Const DeckHeight As Double = 8
	Private Const DeckLength As Double = 3.28 * 90
	Private Const DeckWidth As Double = 3.28 * (6 + 76 + 6)
	
	Private Const HeliDeckLength As Double = 3.28 * 25
	Private Const HeliDeckHeight As Double = 3.28 * 2.5
	Private Const helideckElev As Double = DeckElev + DeckHeight
