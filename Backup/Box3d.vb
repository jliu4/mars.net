...
Friend Class PltBox3d
	...
	Public Sub createBox(ByRef Length As Double, ByRef width As Double, ByRef Height As Double, ByRef xCenter As Double, ByRef ycenter As Double, ByRef zCenter As Double, Optional ByRef rcol As Integer = 0)
	...
	Public Sub PyramidBox(ByRef lBottom As Double, ByRef wBottom As Double, ByRef lTop As Double, ByRef wTop As Double, ByRef theHeight As Double, ByRef xCenter As Object, ByRef ycenter As Object, ByRef zCenter As Object)
