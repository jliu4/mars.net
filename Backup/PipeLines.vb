...
Friend Class PltPipeLines
	...
	Private xyz(MaxNumPipes, MaxNumPipeNodes - 1, 3) As Double '...xyz(pipenumber,pipepoints,GPS sys. coords)
...
ExitErr: 
	...
	Public Sub drawPipeLines(ByRef ShipGlob As ShipGlobal, ByVal ShipDraft As Double)
		...
		Dim Rxyz(MaxNumPipeNodes - 1, 3) As Double
	...
	Public Function ZoomGraph(ByRef aChange As Double, ByRef ShipGlob As ShipGlobal, ByRef ShipDraft As Double) As Boolean
