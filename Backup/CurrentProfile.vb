...
Friend Class CurrentProfile
	...
	Public Function Add(ByVal CDepth As Double, ByVal CVelocity As Double) As CurrentPair
	...
	Public Function VofD(ByVal Depth As Double) As Double
		...
		Dim LastDepth, LastVel As Double
		Matched = False
