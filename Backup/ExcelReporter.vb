...
Friend Class ExcelReporter
	...
	Public Function GetGroundLength(ByVal CurLine As MoorLine, Optional ByRef TopTension As Double = 0#, Optional ByRef HorForce As Double = 0#) As Double
		GetGroundLength = -1
			...
			With .ActiveSheet
				...
				For i = 1 To NumLines
					...
					If System.Math.Abs(oVessel.ShipDraft - oVessel.ShipDraftSur) < 0.8 Then
						'UPGRADE_WARNING: Couldn't resolve default property of object Col. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
						'UPGRADE_WARNING: Couldn't resolve default property of object oxApp.ActiveWorkbook.ActiveSheet.Cells. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
						.Cells(29 + i, Col + 7).FormulaR1C1 = oVessel.MoorSystem.MoorLines(i).PretensionSur / 1000#
					Else
						'UPGRADE_WARNING: Couldn't resolve default property of object Col. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
						'UPGRADE_WARNING: Couldn't resolve default property of object oxApp.ActiveWorkbook.ActiveSheet.Cells. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
						.Cells(29 + i, Col + 7).FormulaR1C1 = oVessel.MoorSystem.MoorLines(i).PretensionOpr / 1000#
					End If
					' intact FS
					'UPGRADE_WARNING: Couldn't resolve default property of object Col. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
					'UPGRADE_WARNING: Couldn't resolve default property of object oxApp.ActiveWorkbook.ActiveSheet.Cells. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
	...
	Sub ReportMooringLayout(ByVal sClient As String, ByVal sLocationName As String, ByVal oVessel As Vessel, Optional ByRef MoorSystem As MoorSystem = Nothing, Optional ByRef ShipLoc As ShipGlobal = Nothing)
		...
		oxBook = oxApp.Workbooks.Add(My.Application.Info.DirectoryPath & "\MooringLayout.xlt")
		...
		'    If Abs(MaxVal - MinVal) < 0.5 Then
		'        oxApp.Range("WirePayoutMax").Formula = ""
		'    End If
		...
		Dim FrcFactor, LFactor As Double
		...
		With oxApp
			If IsMetricUnit Then
				...
				'UPGRADE_WARNING: Couldn't resolve default property of object oxApp.Sheets().Delete. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				.Sheets("Payout").Delete()
				.Application.DisplayAlerts = True
				'UPGRADE_WARNING: Couldn't resolve default property of object oxApp.Sheets().Name. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			...
			'        .Sheets("Payout").Range("L2").Formula = "Prepared for " & sClient
			'        .Sheets("Payout").Range("L3").Formula = "Prepared by DTCEL, www.dtcel.com" & vbCrLf & "281-531-0888  FAX 281-531-5888"
			...
			'UPGRADE_WARNING: Couldn't resolve default property of object oxApp.Sheets().ChartObjects. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			.Sheets("Payout").ChartObjects(2).Activate() ' mooring layout chart
			If MoorSystem Is Nothing Then
				For j = 1 To NumLines
					If oVessel.MoorSystem.MoorLines(j).Connected Then
						'UPGRADE_WARNING: Couldn't resolve default property of object oxApp.ActiveChart.SeriesCollection(j).Name. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
						.ActiveChart.SeriesCollection(j).Name = VB6.Format(oVessel.MoorSystem.MoorLines(j).TopTension / 1000 * FrcFactor, "#0") & FrcUnit
						'UPGRADE_WARNING: Couldn't resolve default property of object oxApp.ActiveChart.SeriesCollection().Points. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
					...
					Else
						'UPGRADE_WARNING: Couldn't resolve default property of object oxApp.ActiveChart.SeriesCollection().Border. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				...
				For j = 32 To 17 + NumLines Step -1
					...
					'UPGRADE_WARNING: Couldn't resolve default property of object oxApp.ActiveChart.SeriesCollection().Delete. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				...
				For j = 16 To NumLines + 1 Step -1
					...
					With .ActiveChart.SeriesCollection(j)
						...
						'UPGRADE_WARNING: Couldn't resolve default property of object oxApp.ActiveChart.SeriesCollection().MarkerStyle. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			...
			With .ActiveChart.Axes(Microsoft.Office.Interop.Excel.XlAxisType.xlCategory)
				'UPGRADE_WARNING: Couldn't resolve default property of object oxApp.ActiveChart.Axes().MinimumScaleIsAuto. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				.MinimumScaleIsAuto = True
				'UPGRADE_WARNING: Couldn't resolve default property of object oxApp.ActiveChart.Axes().MaximumScaleIsAuto. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				.MaximumScaleIsAuto = True
				'UPGRADE_WARNING: Couldn't resolve default property of object oxApp.ActiveChart.Axes().MinorUnitIsAuto. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				.MinorUnitIsAuto = True
				'UPGRADE_WARNING: Couldn't resolve default property of object oxApp.ActiveChart.Axes().MajorUnitIsAuto. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				.MajorUnitIsAuto = True
				'UPGRADE_WARNING: Couldn't resolve default property of object oxApp.ActiveChart.Axes().Crosses. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				.Crosses = Microsoft.Office.Interop.Excel.Constants.xlAutomatic
				'UPGRADE_WARNING: Couldn't resolve default property of object oxApp.ActiveChart.Axes().ReversePlotOrder. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				.ReversePlotOrder = False
				'UPGRADE_WARNING: Couldn't resolve default property of object oxApp.ActiveChart.Axes().ScaleType. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				.ScaleType = Microsoft.Office.Interop.Excel.XlTrendlineType.xlLinear
				'UPGRADE_WARNING: Couldn't resolve default property of object oxApp.ActiveChart.Axes().DisplayUnit. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				.DisplayUnit = Microsoft.Office.Interop.Excel.Constants.xlNone
				'UPGRADE_WARNING: Couldn't resolve default property of object oxApp.ActiveChart.Axes(xlCategory).MinimumScale. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				'UPGRADE_WARNING: Couldn't resolve default property of object oxApp.ActiveChart.Axes().MaximumScale. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				'UPGRADE_WARNING: Couldn't resolve default property of object TmpVal1. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			...
			With .ActiveChart.Axes(Microsoft.Office.Interop.Excel.XlAxisType.xlValue)
				...
				'UPGRADE_WARNING: Couldn't resolve default property of object oxApp.ActiveChart.Axes().DisplayUnit. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				.DisplayUnit = Microsoft.Office.Interop.Excel.Constants.xlNone
				'UPGRADE_WARNING: Couldn't resolve default property of object oxApp.ActiveChart.Axes(xlValue).MinimumScale. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				'UPGRADE_WARNING: Couldn't resolve default property of object oxApp.ActiveChart.Axes().MaximumScale. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				'UPGRADE_WARNING: Couldn't resolve default property of object TmpVal2. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				TmpVal2 = .MaximumScale - .MinimumScale
			End With
			'UPGRADE_WARNING: Couldn't resolve default property of object oxApp.ActiveChart.Axes(xlCategory).MaximumScale. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			'UPGRADE_WARNING: Couldn't resolve default property of object oxApp.ActiveChart.Axes().MinimumScale. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			...
			'UPGRADE_WARNING: Couldn't resolve default property of object oxApp.ActiveChart.Axes(xlValue).MaximumScale. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			'UPGRADE_WARNING: Couldn't resolve default property of object oxApp.ActiveChart.Axes().MinimumScale. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		...
		For i = 1 To NumSegment
			'UPGRADE_WARNING: Couldn't resolve default property of object NumPoints. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		...
		With oxApp.ActiveWorkbook
			...
			'UPGRADE_WARNING: Couldn't resolve default property of object oxApp.ActiveWorkbook.ActiveSheet.ChartObjects. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
...
ErrHandler: 
	...
	Sub ReportMooringAnalysisResults(ByVal sTitle As String, ByRef SubTitle As String, ByVal NumCases As Short, ByVal IsDataEnglishUnit As Boolean, ByRef oVessel As Vessel, ByRef MeanPosition As Motion, ByRef InitPos As Motion, ByRef Stiff As Force, ByRef SigLFM As Motion, ByRef SigWFM As Motion, ByRef Ten() As Double, ByRef TenLF() As Double, ByRef TenWF() As Double)
		...
		Dim WindVel, CurrVel, CurrDir, WindDir As Double
		Dim WaveTp, WaveHs, WaveDir As Double
		Dim SwellTp, SwellHs, SwellDir As Double
	...
	Sub ReportBatchResults(ByVal sTitle As String, ByRef SubTitle As String, ByVal NumCases As Short, ByRef oVessel As Vessel, ByRef InitPos As Motion, ByVal fname As String, ByVal IsMetricUnit As Boolean)
		...
		Dim CurrVel(NumCases) As Double
		...
		Dim CurrDir(NumCases) As Double
		...
		Dim WindVel(NumCases) As Double
		...
		Dim WindDir(NumCases) As Double
		...
		Dim WaveDir(NumCases) As Double
		Dim SwellTp, SwellHs, SwellDir As Double
		...
		Dim VslRzLF(NumCases) As Double
		...
		Dim VslRzWF(NumCases) As Double
		...
		Dim CurrRz2(NumCases) As Double
		...
		Dim WindRz2(NumCases) As Double
		...
		Dim WaveRz2(NumCases) As Double
		...
		Dim StiffRz(NumCases) As Double
		
		Dim j, i, k As Short
		Dim minFS, t As Double
		NumLines = oVessel.MoorSystem.MoorLineCount
		Dim MaxVal, MinVal As Double
		'UPGRADE_WARNING: Lower bound of array tmpVal was changed from 1 to 0. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="0F1C9BE1-AF9D-476E-83B1-17D43BECFF20"'
		Dim tmpVal(NumLines) As Double
		...
		Dim Ten(NumCases, NumLines) As Double
		...
		Dim TenLF(NumCases, NumLines) As Double
		...
		Dim TenWF(NumCases, NumLines) As Double
		...
		oxApp.Workbooks.OpenText(FileName:=fname, StartRow:=1, DataType:=Microsoft.Office.Interop.Excel.XlTextParsingType.xlDelimited, TextQualifier:=Microsoft.Office.Interop.Excel.Constants.xlDoubleQuote, ConsecutiveDelimiter:=False, Tab:=False, Semicolon:=False, Comma:=False, Space:=False, Other:=False, FieldInfo:=New Object(){1, 1})
	...
	Sub OutputSummaryTab(ByRef oxApp As Microsoft.Office.Interop.Excel.Application, ByRef oVessel As Vessel, Optional ByVal WD As Double = 0, Optional ByRef MoorSystem As MoorSystem = Nothing, Optional ByRef ShipLoc As ShipGlobal = Nothing)
		Dim Row, i, NumLines As Short
		Dim CurLine As MoorLine
		Dim MoorLine As New MoorLine
		Dim BS, RetVal As Double
		Dim j As Short
		Dim TmpVal1, TmpVal2 As Double
