...
Friend Class frmAnalysesB
	...
	'    FileOpen As Boolean
	Private HeadE, HeadS, HeadStep As Double
	Private NumHead As Short
	Private hFile As Double
...
ErrHandler: 
	...
	Private Sub StaticAnalysesB(ByVal HeadS As Double, ByVal HeadE As Double, ByVal HeadStep As Double)
		...
		Dim SgnY, SgnX, SgnZ As Double
		Dim Tension(20) As Double
		Dim TSigLF(20) As Double
		Dim TSigWF(20) As Double
		Dim TenTotal(20) As Double
		Dim MaxTen As Double
		Dim N2ndTen, NMaxTen, NID As Short
		Dim minFOS, BS As Double
		Dim NminFOS, N2ndMinFOS As Short
		Dim SID As String
		Dim windHead, EnvHead, waveHead, currHead As Double
		
		'dchen 1/26/04
		Dim NumGL, NinGroup As Short
		
		'    Dim ShipYaw as double
